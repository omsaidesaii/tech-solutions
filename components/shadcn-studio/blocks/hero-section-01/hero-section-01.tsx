    ...
    <section className='flex min-h-[calc(100dvh-4rem)] flex-1 flex-col justify-between gap-12 overflow-x-hidden pt-8 sm:gap-16 sm:pt-16 lg:gap-24 lg:pt-24'>
      ...
      <div className='mx-auto flex max-w-7xl flex-col items-center gap-8 px-4 text-center sm:px-6 lg:px-8'>
        <div className='bg-muted flex items-center gap-2.5 rounded-full border px-3 py-2'>
          ...
          <span className='text-muted-foreground'>Trusted by Fortune 500 Companies</span>
        </div>
        ...
        <p className='text-muted-foreground max-w-2xl'>
          Empower your organization with cutting-edge IT solutions, cloud infrastructure, and digital transformation services.
          <br />
          Drive innovation, enhance productivity, and achieve your business goals.
        </p>
