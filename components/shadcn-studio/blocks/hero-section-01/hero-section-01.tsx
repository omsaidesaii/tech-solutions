...
const HeroSection = () => {
  return (    <section className="flex min-h-[calc(100dvh-4rem)] flex-1 flex-col justify-between gap-12 pt-8 sm:gap-16 sm:pt-16 lg:gap-24 lg:pt-24 relative overflow-hidden">
      ...
      {/* Hero Content */}
      <div className="mx-auto flex max-w-7xl flex-col items-center gap-8 px-4 text-center sm:px-6 lg:px-8 relative z-10">
      ...
      <img
        ...
        className="min-h-67 w-full object-cover relative z-20"
      />
    </section>
  );
};
